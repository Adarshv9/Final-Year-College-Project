// Page component for the Login authentication flow.
...
export default function LoginPage() {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (user.role === 'recruiter') navigate('/recruiter/dashboard');else
      if (user.role === 'admin') navigate('/admin/dashboard');else
      navigate('/dashboard');
    } catch (err) {
