        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Link to="/register" className="w-full sm:w-auto">
            <Button variant="secondary" size="lg" className="w-full sm:w-auto px-8 gap-2 group">
              Hire Talent
              <ArrowRight size={18} className="group-hover:translate-x-1 text-[#64748b] group-hover:text-white transition-all transform" />
            </Button>
          </Link>
        </div>
      </div>
...
function StatsSection() {
  ...
  return (
    <section className="border-y border-[#1e2a3d] bg-[#0f1525]/50">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {stats.map((stat, idx) => (
            <div key={idx} className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-white mb-2">{stat.value}</div>
              <div className="text-sm font-medium text-[#64748b] uppercase tracking-wider">{stat.label}</div>
            </div>
          ))}
        </div>
      </div>
...
function FeatureCard({ icon: Icon, title, description }) {
  return (
    <div className="p-8 rounded-2xl bg-[#131929] border border-[#1e2a3d] hover:border-indigo-500/50 hover:shadow-[0_8px_30px_rgb(99,102,241,0.1)] transition-all duration-300 group">
      <div className="w-14 h-14 bg-[#1a2236] rounded-xl flex items-center justify-center mb-6 group-hover:bg-indigo-500/20 group-hover:text-indigo-400 transition-colors">
        {createElement(Icon, { size: 28, className: 'text-[#94a3b8] group-hover:text-indigo-400' })}
      </div>
    ...
    <section id="features" className="py-24 relative">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-[#e2e8f0] mb-6">Why choose CompasX?</h2>
...
function StepItem({ number, title, description }) {
  return (
    <div className="relative pl-12 pb-12 last:pb-0">
      ...
      <h3 className="text-xl font-semibold text-[#e2e8f0] mb-2 flex items-center gap-2">
        {title}
      </h3>
...
function HowItWorksSection() {
  return (
    <section className="py-24 bg-[#0f1525]">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold text-[#e2e8f0] mb-6">How it works</h2>
          ...
          <div className="relative hidden lg:block">
            ...
            <div className="relative w-full aspect-square max-w-md mx-auto">
              ...
              <div className="absolute inset-4 border border-[#1e2a3d] bg-[#131929]/80 backdrop-blur-xl rounded-2xl shadow-2xl overflow-hidden flex flex-col">
                <div className="h-12 border-b border-[#1e2a3d] flex items-center px-4 gap-2 bg-[#0f1525]">
                  <div className="w-3 h-3 rounded-full bg-rose-500/50" />
                  <div className="w-3 h-3 rounded-full bg-amber-500/50" />
                  <div className="w-3 h-3 rounded-full bg-emerald-500/50" />
                </div>
                <div className="flex-1 p-6 flex flex-col gap-4">
                  <div className="w-1/3 h-6 rounded bg-[#1a2236] animate-pulse" />
                  <div className="w-full h-24 rounded-lg bg-[#1a2236] animate-pulse" />
...
function CTASection() {
  return (
    <section className="py-24 relative overflow-hidden">
      <div className="absolute inset-0 bg-indigo-600 border-t border-[#1e2a3d]" />
